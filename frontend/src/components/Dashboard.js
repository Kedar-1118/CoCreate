...
const Dashboard = () => {
    ...
    return (
        <div className="container bg-blue-300 pt-4 pb-8 rounded-lg">
            <h2 className="my-4">Dashboard</h2>
            <div className="row">
                {documents.map((doc) => (
                    <div key={doc._id} className="col-md-4 mb-4">
                        <div className="card h-100">
                            <div className="card-body d-flex flex-column bg-slate-200 rounded-lg shadow-lg hover:bg-blue-100">
